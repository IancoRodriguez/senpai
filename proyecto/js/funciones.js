...
function cargarSelectDonantes(){
	...
	const selectDonantes = document.getElementById("SelectDonante");

	selectDonantes.innerHTML="";

	const datos = personas.devolverListaPersonas();
...
function registrarDonacion(){
	...
	if (document.getElementById("formRegistroDonaciones").reportValidity()){
		...
		const comentario = document.getElementById("regComentarios").value;

		const donante = document.getElementById("SelectDonante").value;
